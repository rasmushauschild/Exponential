...
-- notifications: you see your own; any member may create one for a teammate; you mark your own read
drop policy if exists notif_read on public.notifications;
create policy notif_read on public.notifications for select to authenticated using (to_user = auth.uid());
...
create policy notif_update on public.notifications for update to authenticated using (to_user = auth.uid());
drop policy if exists notif_delete on public.notifications;
create policy notif_delete on public.notifications for delete to authenticated using (to_user = auth.uid());
